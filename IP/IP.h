...
#define IP_VERSION   15601   // Format: Mmmrr. Example: 10201 is 1.02a
...
/*********************************************************************
*
*       Drivers supplied by SEGGER.
*
*  Other drivers can always be added or developped by end user.
*/
...
void IP_NI_AT32AP7000_ConfigNumRxBuffers(U16 NumRxBuffers);
...
void IP_NI_NIOSII_MaCo_ConfigNumRxBuffers(unsigned Unit, U16 NumRxBuffers);
