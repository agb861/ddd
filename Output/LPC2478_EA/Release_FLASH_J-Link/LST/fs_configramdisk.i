#line 1 "Setup\\FS_ConfigRAMDisk.c"
...
#line 21 "Setup\\FS_ConfigRAMDisk.c"
#line 1 "FS\\FS.h"
...
#line 22 "Setup\\FS_ConfigRAMDisk.c"
...
static unsigned long   _aMemBlock[0x2B00 / 4];      
...
void FS_X_AddDevices(void) {
  ...
  FS_RAMDISK_Configure(0, pRamDisk, 512, 16);
}
...
unsigned long FS_X_GetTimeDate(void) {
  ...
  r  |= (unsigned long)(Day + (Month << 5) + (Year  << 9)) << 16;
  return r;
}
