...
#line 29 "Setup\\Retarget.c"
#line 1 "C:\\Program Files (x86)\\Keil\\V473\\ARM\\ARMCC\\bin\\..\\include\\rt_misc.h"
...
__swi(0xAB) void _WriteC(unsigned op, char *c);



 
__swi(0xAB) void _Exit(unsigned op, unsigned except);
...
__value_in_regs struct __initial_stackheap __user_initial_stackheap(
    ...
    config.stack_base  = (unsigned int)&Image$$CSTACK$$ZI$$Limit;   
