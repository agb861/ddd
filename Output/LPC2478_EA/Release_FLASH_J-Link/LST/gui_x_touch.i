...
static unsigned char _SPI_Send(unsigned char Data) {
  ...
  (*(volatile unsigned long*) ((0xE0020000) + 0x08)) = Data;
  FailsafeCnt = 0;
  while((((*(volatile unsigned long*) ((0xE0020000) + 0x04)) & 0x80) == 0) && (FailsafeCnt < 5000)) {
    FailsafeCnt++;
  }
  if (FailsafeCnt >= 5000) {
  ...
  return (*(volatile unsigned long*) ((0xE0020000) + 0x08));
}
...
static unsigned char _IsTouch(void) {
  unsigned long Z1;
  unsigned long Z2;
  unsigned long x;
  ...
  ((*(volatile unsigned long *)((0xE0028000) + 0x000C)) = (1 << 20));
  _SPI_Send(0x83 | 0x50 | 0x00);
  x   = ((unsigned long)_SPI_Send(0x00)) << 8;
  x  |= (unsigned long)_SPI_Send(0x00);
  x >>= 3;
  ...
  Z1   = ((unsigned long)_SPI_Send(0x00)) << 8;
  Z1  |= (unsigned long)_SPI_Send(0x00);
  Z1 >>= 3;
  ((*(volatile unsigned long *)((0xE0028000) + 0x0004)) = (1 << 20));
  ...
  Z2  = ((unsigned long)_SPI_Send(0x00)) << 8;
  Z2 |= (unsigned long)_SPI_Send(0x00);
  Z2 >>= 3;
  ((*(volatile unsigned long *)((0xE0028000) + 0x0004)) = (1 << 20));
...
int  GUI_TOUCH_X_MeasureY(void) {
  ...
  if (_IsTouch() == 1) {
    ...
    y   = ((unsigned long)_SPI_Send(0x00)) << 8;
    y  |= (unsigned long)_SPI_Send(0x00);
    y >>= 3;
    ((*(volatile unsigned long *)((0xE0028000) + 0x0004)) = (1 << 20));
    return y;
  }
