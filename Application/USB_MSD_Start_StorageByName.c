...
**********************************************************************
*/
static U32 _aSectorBuffer[(4 * 512) / sizeof(U32)];     // Used as sector buffer in order to do read/write sector bursts (~8 sectors at once)
...
static void _AddMSD(void) {
  ...
  //
  {
    ...
    for (i = 0; i < NumVolumes; i++) {
      ...
      InstData.DriverData.pStart       = (void *)i;
